...
public class OperateEx {
    public static void main(String[] args) {
        ...
        System.out.println(" % 연산자 : " + (num1 % num2)); // 나머지 구하는 연산자
        //예외적인 연산
        try {
        ...
        //증감 연산자 : 피연산자를 1씩 증가 또느 감소시키는 연산자
        int num4 = 10;
//        System.out.println(++num4);  // 피연산자의 뒤에 붙은 경우는 후위증감 연산자로 동작, 선 대임 후 증가
...
//        // 논리연산자 : &&(and), ||(or), !(not)
        ...
        rst2 = (x > 0) || (x > y); //true, && 둘중 하나만 참이여도 참
...
//        System.out.println(adult);
        // 문자열 결합 연산자
        System.out.println("Java JDK" + 11.04 +12); // 처음 만나는 데이터 타입이 문자열이면
